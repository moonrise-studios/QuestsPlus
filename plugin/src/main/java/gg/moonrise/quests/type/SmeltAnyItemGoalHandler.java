...
@SpringComponent
public class SmeltAnyItemGoalHandler implements GoalHandler {
    ...
    public SmeltAnyItemGoalHandler(@Lazy QuestService questService, @Lazy QuestResetService resetService) {
    ...
    public QuestType type() {
        return QuestTypes.SMELT_ANY_ITEM;
    }
    ...
    public void onFurnaceExtract(FurnaceExtractEvent event) {
        ...
        questService.progressMatching(event.getPlayer(), type(), resetService.currentResetKey(), amount, quest -> true);
    }
