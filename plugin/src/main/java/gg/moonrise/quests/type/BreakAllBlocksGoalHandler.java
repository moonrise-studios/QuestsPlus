...
@SpringComponent
public class BreakAllBlocksGoalHandler implements GoalHandler {
    ...
    public BreakAllBlocksGoalHandler(@Lazy QuestService questService, @Lazy QuestResetService resetService) {
    ...
    public QuestType type() {
        return QuestTypes.BREAK_ALL_BLOCKS;
    }
